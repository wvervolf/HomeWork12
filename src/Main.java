public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Книга называется - " + bookEnglish.getTitle() + ", она издана в " + bookEnglish.getYear() + " году. А автора этой книги зовут " + author.getName() + " " + author.getSurname());
        ...
        System.out.println("Книга называется - " + bookPhantastic.getTitle() + ", она издана в " + bookPhantastic.getYear() + " году. А автора этой книги зовут " + author.getName() + " " + author.getSurname());
    }
}